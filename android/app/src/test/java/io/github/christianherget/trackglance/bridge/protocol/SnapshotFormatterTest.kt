...
class SnapshotFormatterTest {
    @Test fun distanceThresholdsAndPrecisionMatchLocusMediumFormatting() {
        assertDistance(999.9f, BridgeProtocol.LengthFormat.METRES_KILOMETRES, 1000, BridgeProtocol.FormatCode.M_0)
        assertDistance(1000f, BridgeProtocol.LengthFormat.METRES_KILOMETRES, 10, BridgeProtocol.FormatCode.KM_1)
        assertDistance(99_999f, BridgeProtocol.LengthFormat.METRES_KILOMETRES, 1000, BridgeProtocol.FormatCode.KM_1)
        assertDistance(100_000f, BridgeProtocol.LengthFormat.METRES_KILOMETRES, 100, BridgeProtocol.FormatCode.KM_0)
        assertDistance(304.7f, BridgeProtocol.LengthFormat.FEET_MILES, 1000, BridgeProtocol.FormatCode.FT_0)
        assertDistance(305f, BridgeProtocol.LengthFormat.FEET_MILES, 19, BridgeProtocol.FormatCode.MI_2)
        assertDistance(914.3f, BridgeProtocol.LengthFormat.YARDS_MILES, 1000, BridgeProtocol.FormatCode.YD_0)
        assertDistance(915f, BridgeProtocol.LengthFormat.YARDS_MILES, 57, BridgeProtocol.FormatCode.MI_2)
        assertDistance(1852f, BridgeProtocol.LengthFormat.METRES_NAUTICAL_MILES, 1852, BridgeProtocol.FormatCode.M_0)
        assertDistance(1852.1f, BridgeProtocol.LengthFormat.METRES_NAUTICAL_MILES, 10, BridgeProtocol.FormatCode.NMI_1)
    }

    @Test fun totalAndMovingFormatsAreIndependent() {
    ...
    @Test fun speedAltitudeVerticalSlopeEnergyAndPaceUseConfiguredFamilies() {
        val units = BridgeProtocol.UnitPreferences(
    ...
    @Test fun joulesRatioZeroSpeedNegativeAndUnavailableValuesAreHandled() {
        val metric = format(
            averageSpeedMps = 0f,
            slopeRatio = -0.123f,
            energyJoules = 12_600,
        ...
        val nautical = format(
            currentPaceMinutesPerKilometre = 5f,
            unitPreferences = BridgeProtocol.UnitPreferences.METRIC.copy(
    ...
    @Test fun speedPrecisionChangesOnlyAboveOneHundred() {
    ...
    private fun assertDistance(
        ...
        format(
            ...
            unitPreferences = BridgeProtocol.UnitPreferences.METRIC.copy(length = preference),
        ).distance,
    )
