...
pages and each page at most six metrics. Watch-originated heart rate is available only on Emery.

If the stopped screen remains after starting in Locus, open the Android bridge and confirm that
Locus, Pebble App, watch, and watchapp are connected and on release 0.2.2. Allow Locus and Pebble App
