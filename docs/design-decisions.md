...
**Decision:** The Pebble Locus Bridge is distributed as a single, standard Android APK (`io.github.christianherget.locuspebble.bridge`) that functions both as a standalone Android app and as an optional Locus Map add-on.
**Rationale:** 
