...
val regenerateDocumentationScreenshots = tasks.register<Exec>("regenerateDocumentationScreenshots") {
    group = "documentation"
    description = "Regenerates committed documentation screenshots using Pebble QEMU and browser tooling."
