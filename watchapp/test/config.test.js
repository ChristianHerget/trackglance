...
assert.strictEqual(config.projectionNeeded(13, 34, {a: 12, b: 34}), true);
assert.strictEqual(config.fingerprintsDiffer({a: 12, b: 34}, {a: 12, b: 34}), false);
assert.strictEqual(config.fingerprintsDiffer({a: 12, b: 34}, {a: 13, b: 34}), true);
